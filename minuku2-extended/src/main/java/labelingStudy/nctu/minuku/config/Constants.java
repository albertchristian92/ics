...
public class Constants {
    ...
    //sharedPrefS
    public static final String sharedPrefString = "user_monitoring.nctu_hscc_ac.ocs_v1";

    //file path
    public static final String PACKAGE_DIRECTORY_PATH = "/Android/data/user_monitoring.nctu_hscc_ac.ocs_v1/";
    ...
    public static final String APP_NAME = "OCS";
    public static final String APP_FULL_NAME = "Online Charging System";
    public static final String RUNNING_APP_DECLARATION = APP_FULL_NAME + "is running";
